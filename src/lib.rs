...
pub use boolean::{
    ...
    exact_arrangement_boolean_attempt_report, materialize_adjacent_union_completion_boolean,
    materialize_affine_orthogonal_solid_boolean, materialize_axis_aligned_orthogonal_solid_boolean,
