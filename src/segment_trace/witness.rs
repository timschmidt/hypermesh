//! Exact leaf witnesses and probe geometry.
...
use super::halfspace_witness::{
    ...
    point_strictly_inside_halfspace_cell_or_unknown, push_unique_halfspace_seed,
    seed_family_search_failed_without_any_seed, shifted_halfspace_cell_witnesses_from_seed,
    shifted_halfspace_seed_families_with_report_seed, shifted_halfspace_witness_family_or_empty,
    take_new_halfspace_seed_family,
};
#[cfg(test)]
use super::halfspace_witness::{
    feasible_halfspace_cell_vertex_family, feasible_halfspace_cell_vertices,
};
#[cfg(test)]
...
use super::path::{
    ...
    finalize_interior_point_family, finalize_probe_point_family, other_axes,
    unique_definition_family,
};
